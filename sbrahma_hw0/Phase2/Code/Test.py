...
def TestOperation(ImgPH, ImageSize, ModelPath, DataPath, LabelsPathPred):
	...
	#_, prSoftMaxS = ResNext(ImgPH, ImageSize, 1)
        #_, prSoftMaxS = DenseNet(ImgPH, ImageSize, 1)
	# Setup Saver
...
def main():
    ...
    Parser.add_argument('--ModelPath', dest='ModelPath', default='/home/sayan/PycharmProjects/Checkpoints/resnext/4model.ckpt', help='Path to load latest model from, Default:ModelPath')
    Parser.add_argument('--BasePath', dest='BasePath', default='/home/sayan/PycharmProjects/cmsc733/Phase2/CIFAR10/Test/', help='Path to load images from, Default:BasePath')
    Parser.add_argument('--LabelsPath', dest='LabelsPath', default='/home/sayan/PycharmProjects/cmsc733/TxtFiles/LabelsTest.txt', help='Path of labels file, Default:./TxtFiles/LabelsTest.txt')
    ...
    LabelsPathPred = '../predout.txt' # Path to save predicted labels
